...
const getVisibleExpenses = (expenses, { text, sortBy, startDate, endDate }) => {
  return expenses.filter((expense) => {
    ...
    const endDateMatch = typeof startDate !== 'number' || expense.endDate <= endDate;
...
// const removeExpenseOne = store.dispatch(removeExpense(expenseOne.expense.id));
...
const demoState = {
  expenses: [{
    ...
    note: 'this was the final payment from my last address',
    amount: 54500,
    createdAt: 0
  }],
  filters: {
